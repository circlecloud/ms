...
declare namespace java {
    namespace util {
        namespace concurrent {
            // @ts-ignore
             class ArrayBlockingQueue extends java.util.AbstractQueue {
                /**
                 ...
                 */
                // @ts-ignore
                constructor(capacity: number, fair: boolean)
                /**
                 * Creates an {@code ArrayBlockingQueue} with the given (fixed)
                 ...
                 */
                // @ts-ignore
                constructor(capacity: number, fair: boolean, c: java.util.Collection)
                /**

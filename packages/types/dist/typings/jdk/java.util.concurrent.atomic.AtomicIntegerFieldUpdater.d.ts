declare namespace java {
    namespace util {
        namespace concurrent {
            namespace atomic {
                // @ts-ignore
                abstract class AtomicIntegerFieldUpdater extends java.lang.Object {
                    /**
                     ...
                     */
                    // @ts-ignore
                    public static newUpdater(tclass: java.lang.Class, fieldName: string): java.util.concurrent.atomic.AtomicIntegerFieldUpdater;
                    /**
                     ...
                     */
                    // @ts-ignore
                    public getAndUpdate(obj: java.lang.Object, updateFunction: java.util.function$.IntUnaryOperator): number;
                    /**
                     * Atomically updates the field of the given object managed by this updater
                     ...
                     */
                    // @ts-ignore
                    public updateAndGet(obj: java.lang.Object, updateFunction: java.util.function$.IntUnaryOperator): number;
                    /**
                     ...
                     */
                    // @ts-ignore
                    public getAndAccumulate(obj: java.lang.Object, x: number, accumulatorFunction: java.util.function$.IntBinaryOperator): number;
                    /**
                     * Atomically updates the field of the given object managed by this
                     * updater with the results of applying the given function to the
                     ...
                     */
                    // @ts-ignore
                    public accumulateAndGet(obj: java.lang.Object, x: number, accumulatorFunction: java.util.function$.IntBinaryOperator): number;
                }
            }
        }
    }

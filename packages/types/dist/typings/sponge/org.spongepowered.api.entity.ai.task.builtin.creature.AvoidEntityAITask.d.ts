                        ...
                        namespace builtin {
                            namespace creature {
                                ...
                                interface AvoidEntityAITask extends org.spongepowered.api.entity.ai.task.AITask {
                                     ...
                                     */
                                    // @ts-ignore
                                     getTargetSelector(): java.util.function$.Predicate;
                                    /**
                                     * Sets the {@link Predicate} for filtering which {@link Entity} instances
                                     * are considered to be "avoided" by the owning {@link Agent}.
                                     */
                                    // @ts-ignore
                                     setTargetSelector(predicate: java.util.function$.Predicate): org.spongepowered.api.entity.ai.task.builtin.creature.AvoidEntityAITask;
                                    /**

    ...
    namespace spongepowered {
        namespace api {
            namespace util {
                namespace blockray {
                    // @ts-ignore
                     class BlockRay extends java.lang.Object {
                        /**
                         ...
                         */
                        // @ts-ignore
                        public static allFilter(): java.util.function$.Predicate;
                        /**
                         ...
                         */
                        // @ts-ignore
                        public static onlyAirFilter(): java.util.function$.Predicate;
                        /**
                         * A filter that only allows blocks of a certain type.
                         */
                        // @ts-ignore
                        public static blockTypeFilter(type: org.spongepowered.api.block.BlockType): java.util.function$.Predicate;
                        /**
                         * Extends a filter by a number of blocks, regardless of what the extended
                         * filter does.
                         */
                        // @ts-ignore
                        public static continueAfterFilter(filter: java.util.function$.Predicate, numberOfBlocks: number): java.util.function$.Predicate;
                    }
                }
            }
        }

                ...
                namespace selector {
                    namespace Selector {
                        ...
                        interface Builder extends org.spongepowered.api.util.ResettableBuilder {
                             ...
                             */
                            // @ts-ignore
                             add(arguments: java.lang.Iterable): org.spongepowered.api.text.selector.Selector.Builder;
                            /**
                             * Adds a new {@link Argument} with the specified {@link ArgumentType} and
                             * value to this selector.
                             */
                            // @ts-ignore
                             add(type: org.spongepowered.api.text.selector.ArgumentType, value: java.lang.Object): org.spongepowered.api.text.selector.Selector.Builder;
                            /**
                             ...
                             */
                            // @ts-ignore
                             remove(arguments: java.lang.Iterable): org.spongepowered.api.text.selector.Selector.Builder;
                            /**

        ...
        namespace api {
            namespace network {
                ...
                interface ChannelRegistrar {
                     ...
                     */
                    // @ts-ignore
                     createChannel(plugin: java.lang.Object, channel: string): org.spongepowered.api.network.ChannelBinding.IndexedMessageChannel;
                    /**
                     * Creates a new raw channel binding. The channel can be used to send and
                     * Receive data from {@link ChannelBuf} objects.
                     */
                    // @ts-ignore
                     createRawChannel(plugin: java.lang.Object, channel: string): org.spongepowered.api.network.ChannelBinding.RawDataChannel;
                    /**
                     * Gets a channel binding if a channel registered by that name exists.
                     */
                    // @ts-ignore
                     getChannel(channel: string): java.util.Optional;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getOrCreate(plugin: java.lang.Object, channel: string): org.spongepowered.api.network.ChannelBinding.IndexedMessageChannel;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getOrCreateRaw(plugin: java.lang.Object, channel: string): org.spongepowered.api.network.ChannelBinding.RawDataChannel;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getRegisteredChannels(side: org.spongepowered.api.Platform.Type): java.util.Set;
                    /**

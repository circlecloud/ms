                ...
                namespace inventory {
                    namespace ItemStackGenerator {
                        ...
                        interface Builder extends org.spongepowered.api.util.ResettableBuilder {
                             ...
                             */
                            // @ts-ignore
                             add(consumer: java.util.function$.BiConsumer): org.spongepowered.api.item.inventory.ItemStackGenerator.Builder;
                            /**
                             * Adds all the provided biconsumers from the provided collection.
                             */
                            // @ts-ignore
                             addAll(collection: java.util.Collection): org.spongepowered.api.item.inventory.ItemStackGenerator.Builder;
                            /**

            ...
            namespace data {
                namespace property {
                    ...
                    interface LocationBasePropertyHolder {
                         ...
                         */
                        // @ts-ignore
                         getProperty(coords: any /*Vector3i*/, propertyClass: java.lang.Class): java.util.Optional;
                        /**
                         ...
                         */
                        // @ts-ignore
                         getProperty(x: number, y: number, z: number, propertyClass: java.lang.Class): java.util.Optional;
                        /**
                         * Attempts to retrieve a specific {@link Property} type of the block at the
                         ...
                         */
                        // @ts-ignore
                         getProperty(coords: any /*Vector3i*/, direction: org.spongepowered.api.util.Direction, propertyClass: java.lang.Class): java.util.Optional;
                        /**
                         * Attempts to retrieve a specific {@link Property} type of the block at the
                         * specific location on the given block face. If the property is not
                         * applicable, {@link Optional#empty()} is returned.
                         ...
                         */
                        // @ts-ignore
                         getProperty(x: number, y: number, z: number, direction: org.spongepowered.api.util.Direction, propertyClass: java.lang.Class): java.util.Optional;
                        /**
                         ...
                         */
                        // @ts-ignore
                         getProperties(coords: any /*Vector3i*/): java.util.Collection;
                        /**
                         * Gets an immutable collection of all known {@link Property}s pertaining to
                         * this {@link PropertyHolder}.
                         * <p>{@link Property}s can not be changed such that the property is
                         ...
                         */
                        // @ts-ignore
                         getProperties(x: number, y: number, z: number): java.util.Collection;
                        /**
                         * Gets all the faces of this block that have the given property.
                         */
                        // @ts-ignore
                         getFacesWithProperty(coords: any /*Vector3i*/, propertyClass: java.lang.Class): java.util.Collection;
                        /**
                         * Gets all the faces of this block that have the given property.
                         */
                        // @ts-ignore
                         getFacesWithProperty(x: number, y: number, z: number, propertyClass: java.lang.Class): java.util.Collection;
                    }
                }
            }
        }

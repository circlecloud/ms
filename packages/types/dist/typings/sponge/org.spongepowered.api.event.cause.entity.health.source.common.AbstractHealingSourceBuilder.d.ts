                    ...
                    namespace entity {
                        namespace health {
                            namespace source {
                                namespace common {
                                    // @ts-ignore
                                    abstract class AbstractHealingSourceBuilder extends java.lang.Object implements org.spongepowered.api.event.cause.entity.health.source.HealingSource.HealingSourceBuilder {
                                        // @ts-ignore
                                        constructor()
                                        // @ts-ignore

                ...
                namespace inventory {
                    namespace Inventory {
                        ...
                        interface Builder extends org.spongepowered.api.util.ResettableBuilder {
                             ...
                             */
                            // @ts-ignore
                             listener(type: java.lang.Class, listener: java.util.function$.Consumer): org.spongepowered.api.item.inventory.Inventory.Builder;
                            /**
                             ...
                             */
                            // @ts-ignore
                             forCarrier(carrier: java.lang.Class): org.spongepowered.api.item.inventory.Inventory.Builder;
                            /**
                             * Builds the {@link Inventory}.
                             */
                            // @ts-ignore
                             build(plugin: java.lang.Object): org.spongepowered.api.item.inventory.Inventory;
                        }
                    }
                }
            }

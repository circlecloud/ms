            ...
            namespace service {
                namespace sql {
                    ...
                    interface SqlService {
                         ...
                         */
                        // @ts-ignore
                         getDataSource(jdbcConnection: string): any /*javax.sql.DataSource*/;
                        /**
                         ...
                         */
                        // @ts-ignore
                         getDataSource(plugin: java.lang.Object, jdbcConnection: string): any /*javax.sql.DataSource*/;
                        /**
                         * Returns a possible connection URL for a given alias.
                         */
                        // @ts-ignore
                         getConnectionUrlFromAlias(alias: string): java.util.Optional;
                    }
                }
            }
        }

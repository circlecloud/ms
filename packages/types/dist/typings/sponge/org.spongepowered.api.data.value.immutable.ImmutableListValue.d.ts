                ...
                namespace value {
                    namespace immutable {
                        ...
                        interface ImmutableListValue extends org.spongepowered.api.data.value.immutable.ImmutableCollectionValue {
                             ...
                             */
                            // @ts-ignore
                             with(index: number, value: java.lang.Object): org.spongepowered.api.data.value.immutable.ImmutableListValue;
                            /**
                             ...
                             */
                            // @ts-ignore
                             with(index: number, values: java.lang.Iterable): org.spongepowered.api.data.value.immutable.ImmutableListValue;
                            /**
                             ...
                             */
                            // @ts-ignore
                             set(index: number, element: java.lang.Object): org.spongepowered.api.data.value.immutable.ImmutableListValue;
                            /**
                             * Queries for the index of the provided element. If the element is
                             * not contained in this list, -1 is returned.
                             */
                            // @ts-ignore
                             indexOf(element: java.lang.Object): number;
                        }
                    }
                }
            }

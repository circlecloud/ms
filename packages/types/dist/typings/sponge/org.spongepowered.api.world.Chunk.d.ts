        ...
        namespace api {
            namespace world {
                ...
                interface Chunk extends org.spongepowered.api.world.extent.Extent {
                     ...
                     */
                    // @ts-ignore
                     getNeighbor(direction: org.spongepowered.api.util.Direction): java.util.Optional;
                    /**
                     * Gets the chunk in the given direction from this chunk.
                     */
                    // @ts-ignore
                     getNeighbor(direction: org.spongepowered.api.util.Direction, shouldLoad: boolean): java.util.Optional;
                    // @ts-ignore

            ...
            namespace scoreboard {
                namespace Scoreboard {
                    ...
                    interface Builder extends org.spongepowered.api.util.ResettableBuilder {
                         ...
                         */
                        // @ts-ignore
                         objectives(objectives: java.util.List): org.spongepowered.api.scoreboard.Scoreboard.Builder;
                        /**
                         * Sets the list of {@link Team}s of the {@link Scoreboard}.
                         * <p>By default, this is the empty list.</p>
                         */
                        // @ts-ignore
                         teams(teams: java.util.List): org.spongepowered.api.scoreboard.Scoreboard.Builder;
                        /**

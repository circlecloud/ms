            ...
            namespace network {
                namespace ChannelBinding {
                    ...
                    interface IndexedMessageChannel extends org.spongepowered.api.network.ChannelBinding {
                         ...
                         */
                        // @ts-ignore
                         registerMessage(messageClass: java.lang.Class, messageId: number): void;
                        /**
                         ...
                         */
                        // @ts-ignore
                         registerMessage(messageClass: java.lang.Class, messageId: number, handler: org.spongepowered.api.network.MessageHandler): void;
                        /**
                         * Register a message class to this channel and a handler for receiving
                         * the message. The handler is invoked every time the message is sent to
                         * the given side.
                         */
                        // @ts-ignore
                         registerMessage(messageClass: java.lang.Class, messageId: number, side: org.spongepowered.api.Platform.Type, handler: org.spongepowered.api.network.MessageHandler): void;
                        /**
                         * Register a {@link MessageHandler} for a {@link Message}.
                         */
                        // @ts-ignore
                         addHandler(messageClass: java.lang.Class, side: org.spongepowered.api.Platform.Type, handler: org.spongepowered.api.network.MessageHandler): void;
                        /**
                         * Register a {@link MessageHandler} for a {@link Message}
                         */
                        // @ts-ignore
                         addHandler(messageClass: java.lang.Class, handler: org.spongepowered.api.network.MessageHandler): void;
                        /**

        ...
        namespace api {
            namespace world {
                ...
                interface World extends org.spongepowered.api.world.extent.Extent, org.spongepowered.api.world.weather.WeatherUniverse, org.spongepowered.api.effect.Viewer, org.spongepowered.api.service.context.ContextSource, org.spongepowered.api.text.channel.MessageReceiver, org.spongepowered.api.text.channel.ChatTypeMessageReceiver {
                     ...
                     */
                    // @ts-ignore
                     getChunkAtBlock(blockPosition: any /*Vector3i*/): java.util.Optional;
                    /**
                     * Gets the loaded chunk at the given block coordinate position.
                     */
                    // @ts-ignore
                     getChunkAtBlock(bx: number, by: number, bz: number): java.util.Optional;
                    /**
                     * Gets the loaded chunk at the given chunk coordinate position.
                     */
                    // @ts-ignore
                     getChunk(chunkPosition: any /*Vector3i*/): java.util.Optional;
                    /**
                     * Gets the loaded chunk at the given chunk coordinate position.
                     * <p>In Vanilla, the y coordinate will always be 0.</p>
                     */
                    // @ts-ignore
                     getChunk(cx: number, cy: number, cz: number): java.util.Optional;
                    /**
                     ...
                     */
                    // @ts-ignore
                     loadChunk(chunkPosition: any /*Vector3i*/, shouldGenerate: boolean): java.util.Optional;
                    /**
                     * Gets the chunk at the given chunk coordinate position if it exists or if
                     * {@code shouldGenerate} is true and the chunk is generated.
                     * <p>In Vanilla, the y coordinate will always be 0.</p>
                     */
                    // @ts-ignore
                     loadChunk(cx: number, cy: number, cz: number, shouldGenerate: boolean): java.util.Optional;
                    /**
                     * Gets the chunk at the given chunk coordinate position if it exists or if
                     * {@code shouldGenerate} is true and the chunk is generated.
                     ...
                     */
                    // @ts-ignore
                     loadChunkAsync(chunkPosition: any /*Vector3i*/, shouldGenerate: boolean): java.util.concurrent.CompletableFuture;
                    /**
                     * Gets the chunk at the given chunk coordinate position if it exists or if
                     * {@code shouldGenerate} is true and the chunk is generated.
                     * <p>Unlike {@link #loadChunk(Vector3i, boolean)} this method allows the
                     ...
                     */
                    // @ts-ignore
                     loadChunkAsync(cx: number, cy: number, cz: number, shouldGenerate: boolean): java.util.concurrent.CompletableFuture;
                    /**
                     * Regenerates a chunk at the given chunk coordinate position.
                     */
                    // @ts-ignore
                     regenerateChunk(chunkPosition: any /*Vector3i*/): java.util.Optional;
                    /**
                     * Regenerates a chunk at the given chunk coordinates.
                     */
                    // @ts-ignore
                     regenerateChunk(cx: number, cy: number, cz: number): java.util.Optional;
                    /**
                     * Regenerates a chunk at the given chunk coordinate position.
                     */
                    // @ts-ignore
                     regenerateChunk(chunkPosition: any /*Vector3i*/, flag: org.spongepowered.api.world.ChunkRegenerateFlag): java.util.Optional;
                    /**
                     * Regenerates a chunk at the given chunk coordinates.
                     */
                    // @ts-ignore
                     regenerateChunk(cx: number, cy: number, cz: number, flag: org.spongepowered.api.world.ChunkRegenerateFlag): java.util.Optional;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getLoadedChunks(): java.lang.Iterable;
                    /**

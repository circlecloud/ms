                ...
                namespace value {
                    namespace mutable {
                        ...
                        interface MapValue extends org.spongepowered.api.data.value.mutable.Value {
                             ...
                             */
                            // @ts-ignore
                             put(key: java.lang.Object, value: java.lang.Object): org.spongepowered.api.data.value.mutable.MapValue;
                            /**
                             * Associates all provided {@link Entry} to this map value.
                             */
                            // @ts-ignore
                             putAll(map: java.util.Map): org.spongepowered.api.data.value.mutable.MapValue;
                            /**
                             * Removes the association of the provided key to the value currently
                             * associated.
                             */
                            // @ts-ignore
                             remove(key: java.lang.Object): org.spongepowered.api.data.value.mutable.MapValue;
                            /**
                             * Removes all key value associations of the provided keys.
                             */
                            // @ts-ignore
                             removeAll(keys: java.lang.Iterable): org.spongepowered.api.data.value.mutable.MapValue;
                            /**
                             ...
                             */
                            // @ts-ignore
                             removeAll(predicate: java.util.function$.Predicate): org.spongepowered.api.data.value.mutable.MapValue;
                            /**
                            ...
                            // @ts-ignore
                             values(): any;
                            // @ts-ignore
                             transform(func: java.util.function$.Function): org.spongepowered.api.data.value.mutable.MapValue;
                            // @ts-ignore

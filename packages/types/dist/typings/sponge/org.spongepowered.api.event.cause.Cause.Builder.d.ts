                    ...
                    namespace Cause {
                        // @ts-ignore
                         class Builder extends java.lang.Object implements org.spongepowered.api.util.ResettableBuilder {
                             ...
                             */
                            // @ts-ignore
                            public append(cause: java.lang.Object): org.spongepowered.api.event.cause.Cause.Builder;
                            /**
                             * Inserts the specified object into the cause.
                             */
                            // @ts-ignore
                            public insert(position: number, cause: java.lang.Object): org.spongepowered.api.event.cause.Cause.Builder;
                            /**
                             * Appends all specified objects onto the cause.
                             */
                            // @ts-ignore
                            public appendAll(causes: java.util.Collection): org.spongepowered.api.event.cause.Cause.Builder;
                            /**

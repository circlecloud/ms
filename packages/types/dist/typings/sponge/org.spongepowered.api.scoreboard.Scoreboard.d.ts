        ...
        namespace api {
            namespace scoreboard {
                ...
                interface Scoreboard {
                     ...
                     */
                    // @ts-ignore
                     getObjective(name: string): java.util.Optional;
                    /**
                     * Gets the {@link Objective} currently displayed in a {@link DisplaySlot} on this
                     * scoreboard, if one is present.
                     */
                    // @ts-ignore
                     getObjective(slot: org.spongepowered.api.scoreboard.displayslot.DisplaySlot): java.util.Optional;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getObjectivesByCriteria(criteria: org.spongepowered.api.scoreboard.critieria.Criterion): java.util.Set;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getScores(name: org.spongepowered.api.text.Text): java.util.Set;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getTeam(teamName: string): java.util.Optional;
                    /**
                     ...
                     */
                    // @ts-ignore
                     getMemberTeam(member: org.spongepowered.api.text.Text): java.util.Optional;
                }
            }
        }
    }

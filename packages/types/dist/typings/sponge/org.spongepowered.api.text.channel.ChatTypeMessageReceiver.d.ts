            ...
            namespace text {
                namespace channel {
                    ...
                    interface ChatTypeMessageReceiver {
                         ...
                         */
                        // @ts-ignore
                         sendMessage(type: org.spongepowered.api.text.chat.ChatType, template: org.spongepowered.api.text.TextTemplate, parameters: java.util.Map): void;
                        /**
                         ...
                         */
                        // @ts-ignore
                         sendMessages(type: org.spongepowered.api.text.chat.ChatType, messages: java.lang.Iterable): void;
                    }
                }
            }
        }

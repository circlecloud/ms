                ...
                namespace value {
                    namespace mutable {
                        ...
                        interface Value extends org.spongepowered.api.data.value.BaseValue {
                             ...
                             */
                            // @ts-ignore
                             set(value: java.lang.Object): org.spongepowered.api.data.value.mutable.Value;
                            /**
                             ...
                             */
                            // @ts-ignore
                             transform(func: java.util.function$.Function): org.spongepowered.api.data.value.mutable.Value;
                            /**
